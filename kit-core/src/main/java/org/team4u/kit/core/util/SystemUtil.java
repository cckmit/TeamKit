...
public abstract class SystemUtil {
    ...
    private static void append(StringBuilder builder, String caption, String value) {
        builder.append(caption).append(ValueUtil.defaultIfNull(value, "[n/a]"))
                .append("\n");
    }
     ...
     */
    public static class JvmSpecInfo {
     ...
     */
    public static class JavaSpecInfo {
    ...
    public static class JavaInfo {
        ...
        private boolean getJavaVersionMatches(String versionPrefix) {
            return JAVA_VERSION != null && JAVA_VERSION.startsWith(versionPrefix);
